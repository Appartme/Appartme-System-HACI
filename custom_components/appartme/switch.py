"""Support for Appartme sockets, additional channel, and Tuya switch control."""
...
class AppartmeSwitch(CoordinatorEntity, SwitchEntity):
    """Representation of an Appartme MM switch."""
...
class TuyaSwitch(CoordinatorEntity, SwitchEntity):
    """Representation of a Tuya switch controlled via Appartme PaaS API."""
    ...
    async def async_turn_on(self, **kwargs):
        ...
        try:
            ...
            _LOGGER.error("Error turning on Tuya switch %s: %s", self.name, err)
    ...
    async def async_turn_off(self, **kwargs):
        ...
        try:
            ...
            _LOGGER.error("Error turning off Tuya switch %s: %s", self.name, err)
